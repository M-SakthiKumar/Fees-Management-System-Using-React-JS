...
<h2 className="fs-3 fw-bold text-uppercase text-center mt-3"> Add a Student </h2>
                </div>
...
<div className="col-md-7  ">
    ...
    <input value={id} onChange={(e)=>setid(e.target.value)} type="number" className="form-control" id="inputAddress" placeholder="Enter the Register Number"/>
  </div>
  ...
  <div className="col-12 d-flex justify-content-center ">
    ...
    <Link to="/" className="btn btn-danger mx-1 "> Back  </Link>
  </div>
